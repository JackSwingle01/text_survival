...
public static class OutcomeTemplates
{
    ...
    /// <summary>Severe mauling. Serious attack + strong fear.</summary>
    ...
    /// <summary>Mark something for later investigation.</summary>
