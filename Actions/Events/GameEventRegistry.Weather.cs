...
public static partial class GameEventRegistry
{
    private static GameEvent StormApproaching(GameContext ctx)
    {
        ...
        {
            BaseWeight = 2.0  // High priority when weather worsens
        };
        ...
        var raceToFinish = new EventChoice("Race to Finish",
            ...
            [
                ...
                { TimeAddedMinutes = 25, Effects = [EffectFactory.Cold(-15, 45)] },
                ...
                { TimeAddedMinutes = 15, Effects = [EffectFactory.Cold(-3, 20)] }
            ]);
        ...
        var seekShelter = new EventChoice("Seek Shelter Immediately",
            ...
            [
                ...
                { TimeAddedMinutes = 45, Effects = [EffectFactory.Cold(-2, 30)] },
                new EventResult("The shelter is poor. You're out of the wind but still cold.", weight: 0.30)
                { TimeAddedMinutes = 40, Effects = [EffectFactory.Cold(-8, 35)] },
                ...
                { TimeAddedMinutes = 35, Effects = [EffectFactory.Cold(-12, 40)], NewDamage = new DamageInfo(5, DamageType.Blunt, "debris") }
            ]);
        ...
        var headBack = new EventChoice("Head Back Now",
            ...
            [
                ...
                { AbortsExpedition = true, Effects = [EffectFactory.Cold(-8, 25)] },
    ...
    private static GameEvent Whiteout(GameContext ctx)
    {
        ...
        var keepMoving = new EventChoice("Keep Moving",
            ...
            [
                ...
                { TimeAddedMinutes = 25, Effects = [EffectFactory.Cold(-10, 30)] },
                new EventResult("You're completely lost. When the snow clears, nothing looks familiar.", weight: 0.20)
                { TimeAddedMinutes = 45, Effects = [EffectFactory.Cold(-15, 45)] },
                new EventResult("You walk straight into a hidden hazard.", weight: 0.10)
                { TimeAddedMinutes = 15, NewDamage = new DamageInfo(8, DamageType.Blunt, "fall"), Effects = [EffectFactory.Cold(-8, 25)] }
            ]);
        ...
        var burnFuel = new EventChoice("Burn Fuel for Warmth",
            ...
            [
                ...
                { TimeAddedMinutes = 50, Effects = [EffectFactory.Cold(-5, 25)], Cost = new ResourceCost(ResourceType.Fuel, 2) },
                ...
                { TimeAddedMinutes = 35, Effects = [EffectFactory.Cold(-10, 35)], Cost = new ResourceCost(ResourceType.Fuel, 2) }
            ]);
    ...
    private static GameEvent FrostbiteWarning(GameContext ctx)
    {
        ...
        var treatNow = new EventChoice("Treat It Now",
            ...
            [
                ...
                { TimeAddedMinutes = 10, Effects = [EffectFactory.Cold(-3, 15)] },
                new EventResult("It takes longer than expected, but the feeling returns.", weight: 0.30)
                { TimeAddedMinutes = 20, Effects = [EffectFactory.Cold(-5, 20)] },
                ...
                { TimeAddedMinutes = 15, NewDamage = new DamageInfo(5, DamageType.Internal, "frostbite"),
                  Effects = [EffectFactory.Frostbite(0.3)] }
            ]);
        ...
        var pushOn = new EventChoice("Push On",
            ...
            [
                ...
                { TimeAddedMinutes = 5, Effects = [EffectFactory.Cold(-2, 10)] },
                new EventResult("Your body gives out before you reach safety.", weight: 0.10)
                { TimeAddedMinutes = 30, NewDamage = new DamageInfo(12, DamageType.Internal, "frostbite"), Effects = [EffectFactory.Cold(-20, 60)] }
            ]);
    ...
    private static GameEvent ColdRainSoaking(GameContext ctx)
    {
        ...
        var stripAndWring = new EventChoice("Strip and Wring",
            ...
            [
                ...
                { TimeAddedMinutes = 15, Effects = [EffectFactory.Cold(-5, 20)] },
                new EventResult("The brief exposure causes additional cold damage.", weight: 0.30)
                { TimeAddedMinutes = 15, Effects = [EffectFactory.Cold(-12, 35)] },
                new EventResult("You can't get dry enough. Still soaked.", weight: 0.15)
                { TimeAddedMinutes = 20, Effects = [EffectFactory.Cold(-15, 45)] },
                new EventResult("Something sees you while you're vulnerable.", weight: 0.05)
                { TimeAddedMinutes = 10, Effects = [EffectFactory.Fear(0.3)], AbortsExpedition = true }
            ]);
        ...
        var keepMovingFast = new EventChoice("Keep Moving Fast",
            ...
            [
                ...
                { TimeAddedMinutes = 20, Effects = [EffectFactory.Cold(-18, 50)], NewDamage = new DamageInfo(3, DamageType.Internal, "exposure") },
        ...
        var startFire = new EventChoice("Start Emergency Fire",
            ...
            [
                ...
                { TimeAddedMinutes = 25, Cost = new ResourceCost(ResourceType.Fuel, 1) },
                new EventResult("Everything is too wet. The fire won't catch.", weight: 0.35)
                { TimeAddedMinutes = 20, Effects = [EffectFactory.Cold(-12, 40)] },
                new EventResult("Partial success. A small fire buys you time to dry out somewhat.", weight: 0.25)
                { TimeAddedMinutes = 30, Effects = [EffectFactory.Cold(-5, 25)], Cost = new ResourceCost(ResourceType.Fuel, 1) },
                new EventResult("The fire attempt takes too long. Hypothermia sets in.", weight: 0.10)
                { TimeAddedMinutes = 35, Effects = [EffectFactory.Cold(-20, 60)], Cost = new ResourceCost(ResourceType.Tinder, 1) }
            ]);
    ...
    private static GameEvent LostInFog(GameContext ctx)
    {
        ...
        var waitForLift = new EventChoice("Wait for it to Lift",
            ...
            [
                ...
                { TimeAddedMinutes = 40, Effects = [EffectFactory.Cold(-3, 20)] },
                ...
                { TimeAddedMinutes = 15, Effects = [EffectFactory.Fear(0.3)], AbortsExpedition = true }
            ]);
    ...
    private static GameEvent BitterWind(GameContext ctx)
    {
        ...
        var findWindbreak = new EventChoice("Find a Windbreak",
            ...
            [
                ...
                { TimeAddedMinutes = 8, Effects = [EffectFactory.Cold(-2, 10)] },
                new EventResult("Partial cover. It helps somewhat.", weight: 0.30)
                { TimeAddedMinutes = 12, Effects = [EffectFactory.Cold(-5, 20)] },
                new EventResult("No good options nearby. You waste time looking.", weight: 0.15)
                { TimeAddedMinutes = 18, Effects = [EffectFactory.Cold(-10, 30)] },
        ...
        var keepMoving = new EventChoice("Turn Your Back and Keep Moving",
            ...
            [
                ...
                { TimeAddedMinutes = 10, Effects = [EffectFactory.Cold(-15, 40)] },
        ...
        var buildShelter = new EventChoice("Build a Quick Shelter",
            ...
            [
                ...
                { TimeAddedMinutes = 25, Effects = [EffectFactory.Cold(-2, 15)] },
                ...
                { TimeAddedMinutes = 20, Effects = [EffectFactory.Cold(-10, 30)] },
                new EventResult("Your shelter works too well. You fall asleep and wake up later.", weight: 0.10)
                { TimeAddedMinutes = 60, Effects = [EffectFactory.Cold(-5, 25), EffectFactory.Rested(0.2, 60)] }
            ]);
    ...
    private static GameEvent SuddenClearing(GameContext ctx)
    {
        ...
        var pushFurther = new EventChoice("Push Further",
            ...
            [
                ...
                { TimeAddedMinutes = 15, Effects = [EffectFactory.Cold(-8, 25)] },
        ...
        var scoutFromHere = new EventChoice("Scout from Here",
            ...
            [
                ...
                { TimeAddedMinutes = 5, Effects = [EffectFactory.Fear(0.15)] },
