...
)
{
    public static InventoryDto FromInventory(Inventory inv, string title = "INVENTORY")
    {
        return new InventoryDto(
            ...
            LogsKg: inv.Logs.Sum(),
            StickCount: inv.StickCount,
            SticksKg: inv.Sticks.Sum(),
            TinderCount: inv.TinderCount,
            TinderKg: inv.Tinder.Sum(),
            FuelBurnTimeHours: inv.TotalFuelBurnTimeHours,
            CookedMeatCount: inv.CookedMeatCount,
            CookedMeatKg: inv.CookedMeat.Sum(),
            RawMeatCount: inv.RawMeatCount,
            RawMeatKg: inv.RawMeat.Sum(),
            BerryCount: inv.BerryCount,
            BerriesKg: inv.Berries.Sum(),
            WaterLiters: inv.WaterLiters,
            StoneCount: inv.StoneCount,
            StoneKg: inv.Stone.Sum(),
            BoneCount: inv.BoneCount,
            BoneKg: inv.Bone.Sum(),
            HideCount: inv.HideCount,
            HideKg: inv.Hide.Sum(),
            PlantFiberCount: inv.PlantFiberCount,
            PlantFiberKg: inv.PlantFiber.Sum(),
            SinewCount: inv.SinewCount,
