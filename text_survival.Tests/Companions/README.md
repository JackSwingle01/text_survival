...
These tests started before implementation: 22 acceptance cases, 10 passing and 12 failing. All are now implemented and passing, with 53 companion cases across the complete folder. No cases are skipped.
...
See the [scenario catalogue](../../documentation/companion-system-plan.md) and [implementation/audit notes](../../documentation/companion-implementation.md).
