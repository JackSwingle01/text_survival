...
public class DiscoveryGenerator
{
    ...
    [
        ...
        new(FeatureFactory.CreateBerryBush,
            SpawnChance: 0.08, ExpectedHours: 1.0, DiscoveryCategory.Minor),

        new(FeatureFactory.CreateMixedDeadfall,
            SpawnChance: 0.06, ExpectedHours: 1.5, DiscoveryCategory.Minor),

        new(FeatureFactory.CreateCattails,
            SpawnChance: 0.04, ExpectedHours: 2.0, DiscoveryCategory.Minor),
        ...
        new(DiscoveryFeatureFactory.CreateMedicinePatch,
            SpawnChance: 0.03, ExpectedHours: 2.5, DiscoveryCategory.Minor),

        new(DiscoveryFeatureFactory.CreateResinPocket,
            SpawnChance: 0.04, ExpectedHours: 1.5, DiscoveryCategory.Minor),

        new(DiscoveryFeatureFactory.CreateAbandonedDen,
            SpawnChance: 0.03, ExpectedHours: 2.0, DiscoveryCategory.Minor),
        ...
        new(DiscoveryFeatureFactory.CreateAntlerShed,
            SpawnChance: 0.02, ExpectedHours: 2.0, DiscoveryCategory.Minor),

        new(DiscoveryFeatureFactory.CreateOldButcheringSite,
            SpawnChance: 0.02, ExpectedHours: 2.5, DiscoveryCategory.Minor),

        new(DiscoveryFeatureFactory.CreateTallowPot,
            SpawnChance: 0.01, ExpectedHours: 3.0, DiscoveryCategory.Minor),
        ...
        new(DiscoveryFeatureFactory.CreateMedicineStash,
            SpawnChance: 0.01, ExpectedHours: 3.5, DiscoveryCategory.Major),

        // Major discoveries - rarer, more impactful
        new(FeatureFactory.CreateMassiveDeadfall,
            SpawnChance: 0.02, ExpectedHours: 3.0, DiscoveryCategory.Major),

        new(DiscoveryFeatureFactory.CreateNaturalShelter,
            SpawnChance: 0.01, ExpectedHours: 4.0, DiscoveryCategory.Major),

        // Salvage sites - major finds
        new(SalvageFeature.CreateAbandonedCamp,
            SpawnChance: 0.02, ExpectedHours: 3.5, DiscoveryCategory.Major),
        ...
        new(() => SalvageFeature.FromRewardPool(
            ...
            SpawnChance: 0.02, ExpectedHours: 4.0, DiscoveryCategory.Major),
    ...
    [
        new(FeatureFactory.CreateBerryBush,
            SpawnChance: 0.09, ExpectedHours: 0.8, DiscoveryCategory.Minor),

        new(FeatureFactory.CreateMixedDeadfall,
            SpawnChance: 0.05, ExpectedHours: 1.2, DiscoveryCategory.Minor),
        ...
        // New discoveries
        new(DiscoveryFeatureFactory.CreateOldButcheringSite,
            SpawnChance: 0.01, ExpectedHours: 2.5, DiscoveryCategory.Minor),
    ...
    [
        ...
        new(DiscoveryFeatureFactory.CreatePlainSmallGame,
            SpawnChance: 0.05, ExpectedHours: 1.5, DiscoveryCategory.Minor),
        ...
        new(() => new EventTriggerFeature("frozen_traveler"),
            SpawnChance: 0.02, ExpectedHours: 5.0, DiscoveryCategory.Major),
    ...
    [
        ...
        new(DiscoveryFeatureFactory.CreateAntlerShed,
            SpawnChance: 0.03, ExpectedHours: 1.5, DiscoveryCategory.Minor),
        ...
        new(DiscoveryFeatureFactory.CreateNaturalShelter,
            SpawnChance: 0.03, ExpectedHours: 3.0, DiscoveryCategory.Major),
        ...
        new(() => new EventTriggerFeature("hidden_cache"),
            SpawnChance: 0.03, ExpectedHours: 4.0, DiscoveryCategory.Major),
    ...
    [
        ...
        new(DiscoveryFeatureFactory.CreateNaturalShelter,
            SpawnChance: 0.03, ExpectedHours: 2.5, DiscoveryCategory.Major),
    ...
    [
        ...
        new(DiscoveryFeatureFactory.CreateMarshWaterfowl,
            SpawnChance: 0.06, ExpectedHours: 1.0, DiscoveryCategory.Minor),
